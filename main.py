    ...
    def score(self):
        for i in range(3):
            try:
                ...
                self.log(f"Memulai Game {i + 1}/3. Waktu bermain: {gametime} seconds", 'INFO')
                self.wait(gametime)
                ...
                if res.status_code == 200:
                    ...
                    self.log(f"Game Berhasil Dimainkan: diterima {score} points | Total: {self.info['score']}","SUCCESS")
